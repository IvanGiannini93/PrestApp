  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-8 mb-6">
        <button onClick={() => navigate('/admin/clientes?nuevo=true')} className="flex flex-col items-center gap-2 group">
        ...
        <button onClick={() => navigate('/admin/prestamos?nuevo=true')} className="flex flex-col items-center gap-2 group">
          <div className="w-14 h-14 rounded-full border-2 border-primary-300 flex items-center justify-center group-hover:bg-primary-50 group-hover:border-primary-500 transition-all">
            <svg className="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
